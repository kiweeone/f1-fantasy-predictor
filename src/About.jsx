...
/* ═══════════════════════════════════════
   ABOUT PAGE — actualidea.com style
   Big header, two-column bio, CV link
   ═══════════════════════════════════════ */
...
export default function About() {
  ...
  return (
    <div style={{ minHeight: "100vh", background: "#f0f0f0", fontFamily: font, color: "#1a1a1a" }}>
      ...
      {/* ─── HEADER — big "About" with contact info ─── */}
      <section className="fu1" style={{ padding: "20px 48px 40px", maxWidth: 1200, margin: "0 auto" }}>
        <div style={{ borderTop: "3px solid #1a1a1a", paddingTop: 24, display: "flex", justifyContent: "space-between", alignItems: "flex-start" }}>
          <h1 style={{
            fontSize: "clamp(72px, 10vw, 140px)", fontWeight: 900,
            letterSpacing: "-0.04em", lineHeight: 0.95,
          }}>
            About
          </h1>
          <div style={{ textAlign: "right", fontSize: 14, lineHeight: 1.8, color: "#666", paddingTop: 8 }}>
      ...
      {/* ─── BIO — two column like actualidea ─── */}
      <section className="fu2" style={{ padding: "0 48px 80px", maxWidth: 1200, margin: "0 auto" }}>
        <div style={{ borderTop: "1px solid #ccc", paddingTop: 40, display: "grid", gridTemplateColumns: "1fr 1.4fr", gap: 60 }}>
          {/* Left: intro */}
          <div>
      ...
      {/* ─── JOURNEY TIMELINE ─── */}
      <section className="fu3" style={{ padding: "0 48px 80px", maxWidth: 1200, margin: "0 auto" }}>
        <div style={{ borderTop: "1px solid #ccc", paddingTop: 40 }}>
          <div style={{ fontSize: 12, fontWeight: 700, color: "#bbb", textTransform: "uppercase", letterSpacing: 3, marginBottom: 32 }}>
            My Journey
          </div>
            ...
            {[
              {
                ...
                company: "Credissimo",
                desc: "Product ecosystem leadership — CPO managing 5 brands, 40+ person team, platform transformation. Led native mobile platform launch (50K downloads), BNPL marketplace, and multiple 0→1 product launches.",
                color: "#e10600",
              },
              {
                period: "2021 – 2023",
                ...
                company: "Credissimo",
                desc: "Applied product expertise to FinTech — launched 3 products from 0→1 (€30M+ annual volume). Built Xtra.bg, PlatiPosle.bg (BNPL), and contributed to Nolus.io (DeFi).",
                color: "#FF8000",
              },
              {
                period: "2016 – 2021",
                title: "Director of Extraordinary",
                company: "Saatchi & Saatchi / Digitas Sofia",
                desc: "Built experiential/interactive products — robotic installations, AR experiences, national education platforms. Engineering-driven executions with measurable business impact. 10+ awards.",
                color: "#3671C6",
              },
            ].map((exp, i) => (
              <div key={i} style={{
                ...
                <div>
                  <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 8 }}>
                    <div style={{ width: 4, height: 20, borderRadius: 2, background: exp.color }} />
                    <span style={{ fontSize: 18, fontWeight: 700 }}>{exp.title}</span>
                  </div>
                  <p style={{ fontSize: 15, lineHeight: 1.7, color: "#666" }}>{exp.desc}</p>
                </div>
              </div>
            ))}
          </div>
          ...
          <div style={{ display: "flex", flexWrap: "wrap", gap: 10 }}>
            {[
              ...
              <span key={s} style={{
                ...
                background: "#e8e8e8", borderRadius: 8, color: "#555",
              }}>{s}</span>
            ))}
          </div>
        </div>
      ...
      <section style={{ padding: "0 48px 100px", maxWidth: 1200, margin: "0 auto" }}>
        <div style={{ borderTop: "1px solid #ccc", paddingTop: 40, display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: 20 }}>
          <div>
            <div style={{ fontSize: 24, fontWeight: 800, marginBottom: 4 }}>Full CV</div>
            <div style={{ fontSize: 14, color: "#999" }}>Complete professional history, projects, and awards</div>
          </div>
          <a
            href="/cv.pdf"
            target="_blank"
            rel="noopener"
            style={{
              padding: "16px 36px", background: "#1a1a1a", color: "#fff",
              borderRadius: 10, fontSize: 16, fontWeight: 700, letterSpacing: 0.5,
